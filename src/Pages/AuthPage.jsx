...
const AuthPage = () => {
  return (
    <div className='flex flex-col my-12 gap-8 items-center justify-center min-h-190'>
       <div className='text-center text-base-content mb-6 max-w-2xl '>
  ...
  <p className='text-base-content opacity-70 text-lg leading-relaxed'>
    ...
    that fits your role and begin your experience with us.
        ...
        <Link to="/auth/login" className='btn btn-warning text-2xl py-8 lg:text-3xl font-bold w-80 lg:w-125 rounded-2xl'><LogIn /> Log In</Link>
    </div>
  );
};
